...
cd $OpenNMT_py
python3 preprocess.py -train_src $data_path/tree-feat/src-train-tagged.txt -train_tgt $data_path/tgt-train.txt -valid_src $data_path/tree-feat/src-val-tagged.txt -valid_tgt $data_path/tgt-val.txt -src_seq_length 1010 -tgt_seq_length 100 -src_vocab_size 1000 -tgt_vocab_size 1000 -dynamic_dict -share_vocab -save_data $data_path/tree-feat/final-tagged 2>&1 > $data_path/tree-feat/preprocess.out
