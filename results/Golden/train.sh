...
cd $OpenNMT_py
python3 train.py -data $data_path/final -encoder_type brnn -enc_layers 2 -decoder_type rnn -dec_layers 2 -rnn_size 256 -global_attention general -batch_size 32 -word_vec_size 256 -bridge -copy_attn -reuse_copy_attn -train_steps 20000 -gpu_ranks 0 -save_checkpoint_steps 10000 -save_model $data_path/final-model-retrained > $data_path/train.final.out
