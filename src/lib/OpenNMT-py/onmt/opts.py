...
def model_opts(parser):
    ...
    group.add('--numerical_feat_names', '-numerical_feat_names', default=[],
              help="""List of feature names in the form 'src_feat_n'. These features
                      will not be embedded and will just be used as numbers.""")
...
def preprocess_opts(parser):
    ...
    group.add('--tgt_vocab', '-tgt_vocab', default="",
              help="""Path to an existing target vocabulary. Format:
                       one word per line.""")
    group.add('--numerical_feat_names', '-numerical_feat_names', default=[],
              help="""List of feature names in the form 'src_feat_n' 
              with n being the number of the feature """)
